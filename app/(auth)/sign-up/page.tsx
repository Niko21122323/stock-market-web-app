  ...
  return (
    <>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <div className="sign-up-scrollbar gap-4 lg:max-h-[500px] lg:overflow-y-auto pr-0 lg:hover:pr-4 transition-all duration-300 ease-in-out grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1">
          <InputField
            name="fullName"
            label="Full Name"
          ...
          <SelectField
            ...
            placeholder="Select Your investment goall"
