...
import { Loader2, SearchIcon, Star, TrendingUp } from "lucide-react";
							...
							{displayStocks?.map((stock) => (
								...
								>
									<Link
										...
										className="cursor-pointer hover:text-white flex items-center justify-between w-full"
									>
										<div className="">
											<TrendingUp className="h-4 w-4 text-foreground/80 group-hover:text-background transition-colors duration-300 ease-in-out" />
